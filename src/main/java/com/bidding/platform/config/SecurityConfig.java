package com.bidding.platform.config;
...
import com.bidding.platform.auth.security.JwtAuthenticationEntryPoint;
import com.bidding.platform.auth.security.JwtRequestFilter;
        ...
        http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers("/login", "/register", "/verify-otp", "/send-otp", "/check-validity", "/api/city/{id}",
                                "/api/city/get-list", "/buyer/complete",
